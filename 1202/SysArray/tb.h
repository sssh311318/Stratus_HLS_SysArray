...
SC_MODULE( tb )
{
	...
	cynw_p2p < InputType >::out act_in_vec[N]; // data going in to the design
	cynw_p2p < InputType >::out weight_in_vec[N];
	cynw_p2p < AccumType >::in accum_out_vec[N];  // data going out of the design
