...
#endif
{
    ...
    void link_signals(const char *module_path, const char *sim_domain)
    {
		...
		esc_link_signals( &accum_inter_busy_0, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &accum_inter_busy_1, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &accum_inter_busy_2, module_path, sim_domain, true, inputDelay );
		esc_link_signals( &accum_inter_vld_0, module_path, sim_domain, true );
		esc_link_signals( &accum_inter_vld_1, module_path, sim_domain, true );
		esc_link_signals( &accum_inter_vld_2, module_path, sim_domain, true );
		esc_link_signals( &accum_inter_data_0, module_path, sim_domain, true );
		esc_link_signals( &accum_inter_data_1, module_path, sim_domain, true );
		esc_link_signals( &accum_inter_data_2, module_path, sim_domain, true );
