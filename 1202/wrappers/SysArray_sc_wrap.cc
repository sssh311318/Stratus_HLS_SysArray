...
void SysArray_wrapper::InitInstances(  )
{
    ...
    SysArray0->accum_inter_busy_0(accum_inter[0].busy);
    SysArray0->accum_inter_busy_1(accum_inter[1].busy);
    SysArray0->accum_inter_busy_2(accum_inter[2].busy);
    SysArray0->accum_inter_vld_0(accum_inter[0].vld);
    SysArray0->accum_inter_vld_1(accum_inter[1].vld);
    SysArray0->accum_inter_vld_2(accum_inter[2].vld);
    SysArray0->accum_inter_data_0(accum_inter[0].data);
    SysArray0->accum_inter_data_1(accum_inter[1].data);
    SysArray0->accum_inter_data_2(accum_inter[2].data);
