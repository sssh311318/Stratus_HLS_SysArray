...
#include	"/users/student/mr112/czwu23/JJLAB/SystolicArray/1202/SysArray/SysArray.cc"
...
void SysArray_wrapper::InitInstances(  )
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    SysArray_cosim0->accum_inter_busy_0(accum_inter[0].busy);
		    SysArray_cosim0->accum_inter_busy_1(accum_inter[1].busy);
		    SysArray_cosim0->accum_inter_busy_2(accum_inter[2].busy);
		    SysArray_cosim0->accum_inter_vld_0(accum_inter[0].vld);
		    SysArray_cosim0->accum_inter_vld_1(accum_inter[1].vld);
		    SysArray_cosim0->accum_inter_vld_2(accum_inter[2].vld);
		    SysArray_cosim0->accum_inter_data_0(accum_inter[0].data);
		    SysArray_cosim0->accum_inter_data_1(accum_inter[1].data);
		    SysArray_cosim0->accum_inter_data_2(accum_inter[2].data);
		...
		case BDWRep_RTL_C:
		    ...
		    SysArray_rtl0->accum_inter_busy_0(accum_inter[0].busy);
		    SysArray_rtl0->accum_inter_busy_1(accum_inter[1].busy);
		    SysArray_rtl0->accum_inter_busy_2(accum_inter[2].busy);
		    SysArray_rtl0->accum_inter_vld_0(accum_inter[0].vld);
		    SysArray_rtl0->accum_inter_vld_1(accum_inter[1].vld);
		    SysArray_rtl0->accum_inter_vld_2(accum_inter[2].vld);
		    SysArray_rtl0->accum_inter_data_0(accum_inter[0].data);
		    SysArray_rtl0->accum_inter_data_1(accum_inter[1].data);
		    SysArray_rtl0->accum_inter_data_2(accum_inter[2].data);
		...
		case BDWRep_Behavioral:
		    ...
		    SysArray0->accum_inter[0].busy(accum_inter[0].busy);
		    SysArray0->accum_inter[1].busy(accum_inter[1].busy);
		    SysArray0->accum_inter[2].busy(accum_inter[2].busy);
		    SysArray0->accum_inter[0].vld(accum_inter[0].vld);
		    SysArray0->accum_inter[1].vld(accum_inter[1].vld);
		    SysArray0->accum_inter[2].vld(accum_inter[2].vld);
		    SysArray0->accum_inter[0].data(accum_inter[0].data);
		    SysArray0->accum_inter[1].data(accum_inter[1].data);
		    SysArray0->accum_inter[2].data(accum_inter[2].data);
...
void SysArray_wrapper_r::InitInstances()
{
	...
	switch ( rep )
	{
		case BDWRep_Gates:
		    ...
		    SysArray_cosim0->accum_inter_busy_0(accum_inter_busy_0);
		    SysArray_cosim0->accum_inter_busy_1(accum_inter_busy_1);
		    SysArray_cosim0->accum_inter_busy_2(accum_inter_busy_2);
		    SysArray_cosim0->accum_inter_vld_0(accum_inter_vld_0);
		    SysArray_cosim0->accum_inter_vld_1(accum_inter_vld_1);
		    SysArray_cosim0->accum_inter_vld_2(accum_inter_vld_2);
		    SysArray_cosim0->accum_inter_data_0(accum_inter_data_0);
		    SysArray_cosim0->accum_inter_data_1(accum_inter_data_1);
		    SysArray_cosim0->accum_inter_data_2(accum_inter_data_2);
		...
		case BDWRep_RTL_C:
		    ...
		    SysArray_rtl0->accum_inter_busy_0(accum_inter_busy_0);
		    SysArray_rtl0->accum_inter_busy_1(accum_inter_busy_1);
		    SysArray_rtl0->accum_inter_busy_2(accum_inter_busy_2);
		    SysArray_rtl0->accum_inter_vld_0(accum_inter_vld_0);
		    SysArray_rtl0->accum_inter_vld_1(accum_inter_vld_1);
		    SysArray_rtl0->accum_inter_vld_2(accum_inter_vld_2);
		    SysArray_rtl0->accum_inter_data_0(accum_inter_data_0);
		    SysArray_rtl0->accum_inter_data_1(accum_inter_data_1);
		    SysArray_rtl0->accum_inter_data_2(accum_inter_data_2);
		...
		case BDWRep_Behavioral:
		    ...
		    SysArray0->accum_inter[0].busy(accum_inter_busy_0);
		    SysArray0->accum_inter[1].busy(accum_inter_busy_1);
		    SysArray0->accum_inter[2].busy(accum_inter_busy_2);
		    SysArray0->accum_inter[0].vld(accum_inter_vld_0);
		    SysArray0->accum_inter[1].vld(accum_inter_vld_1);
		    SysArray0->accum_inter[2].vld(accum_inter_vld_2);
		    SysArray0->accum_inter[0].data(accum_inter_data_0);
		    SysArray0->accum_inter[1].data(accum_inter_data_1);
		    SysArray0->accum_inter[2].data(accum_inter_data_2);
